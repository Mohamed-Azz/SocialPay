    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-72 bg-white dark:bg-stone-900 border-l border-slate-200 dark:border-stone-800 flex flex-col h-full shadow-sm">
            ...
            <nav class="flex-1 overflow-y-auto p-4 space-y-2">
                ...
                <a class="flex items-center gap-3 px-4 py-3 rounded-xl bg-primary text-white font-medium transition-colors text-slate-700 dark:text-slate-300" href="<?= URLROOT; ?>/admin/users">
