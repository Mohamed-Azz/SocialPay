...
<head>
    ...
    <style>
        body { font-family: 'Noto Sans Arabic', 'Public Sans', sans-serif; }
    ...
    <div class="relative flex h-full min-h-screen w-full flex-col overflow-x-hidden">
        <header class="flex items-center p-4 justify-between bg-transparent">
            ...
            <div class="flex-1 text-center pr-12">
                <h1 class="text-slate-900 dark:text-slate-100 text-lg font-bold leading-tight tracking-tight">تسجيل دخول الإدارة</h1>
            </div>
        </header>
        <main class="flex-1 flex flex-col px-6 pb-12">
            ...
            <div class="text-center mb-8">
                <h2 class="text-slate-900 dark:text-slate-100 text-3xl font-bold leading-tight mb-2">لوحة تحكم الإدارة</h2>
                <p class="text-slate-600 dark:text-slate-400 text-base font-normal">يرجى إدخال بيانات الاعتماد للوصول إلى النظام</p>
            </div>
            ...
            <form action="<?= URLROOT; ?>/auth/postLogin" method="POST" class="space-y-6 max-w-md mx-auto w-full">
                <div class="flex flex-col gap-2">
                    <label class="flex flex-col w-full">
                        <span class="text-slate-800 dark:text-slate-200 text-base font-medium pb-2">البريد الإلكتروني</span>
                        <div class="relative">
                            <input name="email" class="form-input flex w-full rounded-xl text-slate-900 dark:text-slate-100 focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 h-14 placeholder:text-slate-400 p-4 text-left" placeholder="example@domain.com" type="email" required/>
                ...
                <div class="flex flex-col gap-2">
                    <label class="flex flex-col w-full">
                        <span class="text-slate-800 dark:text-slate-200 text-base font-medium pb-2">كلمة المرور</span>
                        <div class="relative">
                            <input name="password" class="form-input flex w-full rounded-xl text-slate-900 dark:text-slate-100 focus:outline-0 focus:ring-2 focus:ring-primary/50 border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 h-14 placeholder:text-slate-400 p-4 text-left" type="password" placeholder="••••••••" required/>
                ...
                <div class="flex flex-col items-center gap-4 pt-6">
                    <a href="<?= URLROOT; ?>/portal/login" class="text-primary font-medium hover:underline">العودة لدخول الموظفين</a>
